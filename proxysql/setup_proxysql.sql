...
--上报 MySQL 8.0 版本（默认 5.5.30 会让 Connector/J 查询已移除的 query_cache_size 而报错）
UPDATE global_variables SET variable_value='8.0.46' WHERE variable_name='mysql-server_version';
